...
consentForm.addEventListener('submit', function(e){
  ...
  modalText.innerHTML = `
    <div class="modal-inner-loading">
        <img src="./img/loading.svg" class="loading" alt="">
  ...
  setTimeout(function(){
    document.getElementById('modal-inner').innerHTML = `
        ...
        <p>Merry will be 23 and rich MUHAHHAHAH!!</p>
        <div class="idiot-gif">
            <img src="img/pirate.gif" alt="">
        </div>
          <a href="./index2.html" class="button">OFF YOU GO!</a>
